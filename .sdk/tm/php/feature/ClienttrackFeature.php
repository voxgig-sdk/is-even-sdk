...
// IsEven SDK clienttrack feature
...
class IsEvenClienttrackFeature extends IsEvenBaseFeature
{
    ...
    public function PostConstruct(IsEvenContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IsEven-SDK';
