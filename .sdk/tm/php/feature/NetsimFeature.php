...
class IsEvenNetsimFeature extends IsEvenBaseFeature
{
    ...
    private function _simulate(IsEvenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IsEvenContext $ctx, array $applied): void
    {
        $client = $this->client;
