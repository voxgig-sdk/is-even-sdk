...
class IsEvenProxyFeature extends IsEvenBaseFeature
{
    ...
    public function init(IsEvenContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IsEvenContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
