...
class IsEvenRatelimitFeature extends IsEvenBaseFeature
{
    ...
    private function _acquire(IsEvenContext $ctx): void
    {
    ...
    private function _track(IsEvenContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
