...
class IsEvenStreamingFeature extends IsEvenBaseFeature
{
    ...
    private function _iterate(IsEvenResult $result): \Generator
    {
    ...
    private function _streamable(IsEvenContext $ctx): bool
    {
