...
class IsEvenTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IsEvenTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = IsEvenTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = IsEvenTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
