...
describe('exists', async () => {
  ...
  //
  // IsEvenSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof IsEvenSDK, true,
      'IsEvenSDK.test() must return a client synchronously')
  })
