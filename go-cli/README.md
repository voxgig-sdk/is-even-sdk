...
AQL-driven CLI and REPL for the IsEven SDK. Positional arguments are
...
./is-even-cli list number_parity
./is-even-cli load 1 number_parity
./is-even-cli load '{id:1}' number_parity
