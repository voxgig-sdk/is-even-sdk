...
func registerSDKWords(r *eng.Registry, client *sdk.IsEvenSDK) {
...
func runOp(client *sdk.IsEvenSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
