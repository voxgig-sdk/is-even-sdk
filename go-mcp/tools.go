...
type Args struct {
	Entity string         `json:"entity" jsonschema:"number_parity"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IsEvenSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "is-even_list",
		Description: "List records from IsEven. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "is-even_load",
		Description: "Load a single record from IsEven. " +
...
func runOp(client *sdk.IsEvenSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IsEvenSDK, name string) (sdk.IsEvenEntity, error) {
	switch strings.ToLower(name) {
	case "number_parity":
		return client.NumberParity(nil), nil
