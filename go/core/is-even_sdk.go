...
func (sdk *IsEvenSDK) OptionsMap() map[string]any {
...
func (sdk *IsEvenSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IsEvenSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IsEvenSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IsEvenSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IsEvenSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IsEvenSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IsEvenSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IsEvenSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IsEvenSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IsEvenSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
