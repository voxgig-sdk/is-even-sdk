...
func NewNumberParityEntity(client *core.IsEvenSDK, entopts map[string]any) *NumberParityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NumberParityEntity) GetName() string { return e.name }
...
func (e *NumberParityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NumberParityEntity) Deleted() bool {
	return e.deleted
}


func (e *NumberParityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNumberParityEntity(e.client, opts)
}

func (e *NumberParityEntity) Data(args ...any) any {
...
func (e *NumberParityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NumberParity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NumberParityEntity) DataTyped(data ...NumberParity) NumberParity {
	if len(data) > 0 {
		return typedFrom[NumberParity](e.Data(asMap(data[0])))
	}
	return typedFrom[NumberParity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NumberParity (all fields
// optional at the wire level).
func (e *NumberParityEntity) MatchTyped(match ...NumberParity) NumberParity {
	if len(match) > 0 {
		return typedFrom[NumberParity](e.Match(asMap(match[0])))
	}
	return typedFrom[NumberParity](e.Match())
}
...
func (e *NumberParityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NumberParityEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NumberParityLoadMatch and returns an NumberParity. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NumberParityEntity) LoadTyped(reqmatch NumberParityLoadMatch, ctrl map[string]any) (NumberParity, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NumberParity{}, err
	}
	return typedFrom[NumberParity](res), nil
}



func (e *NumberParityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NumberParityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NumberParityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NumberParityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NumberParityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
