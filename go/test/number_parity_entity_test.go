...
func TestNumberParityEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set ISEVEN_TEST_NUMBER_PARITY_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func number_parityBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("ISEVEN_TEST_NUMBER_PARITY_ENTID")
