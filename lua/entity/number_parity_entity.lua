...
local NumberParityEntity = {}
NumberParityEntity.__index = NumberParityEntity


function NumberParityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NumberParityEntity)
  self._name = "number_parity"
  self._client = client
...
function NumberParityEntity:get_name()
  return self._name
end


function NumberParityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NumberParityEntity.new(self._client, opts)
end
...
function NumberParityEntity:mark_deleted()
  self._deleted = true
end


function NumberParityEntity:deleted()
  return true == self._deleted
end


function NumberParityEntity:data_set(args)
  if args ~= nil then
...
function NumberParityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NumberParityEntity:match_set(args)
  if args ~= nil then
...
function NumberParityEntity:match_get()
...
function NumberParityEntity:stream(action, args, callopts)
...
function NumberParityEntity:_run_op(ctx, post_done)
  local utility = self._utility
