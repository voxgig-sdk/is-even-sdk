...
IsEvenSDK._make_feature = _make_feature


function IsEvenSDK.new(options)
  local self = setmetatable({}, IsEvenSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IsEvenSDK:options_map()
...
function IsEvenSDK:get_utility()
  return Utility.copy(self._utility)
end


function IsEvenSDK:get_root_ctx()
  return self._rootctx
end


function IsEvenSDK:prepare(fetchargs)
...
function IsEvenSDK:direct(fetchargs)
...
-- by passing it.
function IsEvenSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IsEvenSDK:graphql(query, variables, ctrl)
...
function IsEvenSDK:NumberParity(data)
  ...
  if data == nil then
    if self._number_parity == nil then
      self._number_parity = EntityMod.new(self, nil)
    end
...
function IsEvenSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IsEvenSDK.new(sdkopts)
  sdk.mode = "test"
