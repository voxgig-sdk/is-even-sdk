...
describe("NumberParityDirect", function()
  it("should direct-load-number_parity", function()
    local setup = number_parity_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-number_parity", setup.live and "live" or "unit")
...
function number_parity_direct_setup(mockres)
  ...
  local live = env["IS_EVEN_TEST_LIVE"] == "TRUE"
