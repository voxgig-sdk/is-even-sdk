...
describe("NumberParityEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set IS_EVEN_TEST_NUMBER_PARITY_ENTID JSON to run live")
      return
    end
...
function number_parity_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("IS_EVEN_TEST_NUMBER_PARITY_ENTID")
  ...
  if env["IS_EVEN_TEST_LIVE"] == "TRUE" then
