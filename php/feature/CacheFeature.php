...
class IsEvenCacheFeature extends IsEvenBaseFeature
{
    ...
    private function _through(IsEvenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
