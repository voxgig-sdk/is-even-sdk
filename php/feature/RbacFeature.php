...
class IsEvenRbacFeature extends IsEvenBaseFeature
{
    ...
    private function _required(IsEvenContext $ctx): ?string
    {
    ...
    private function _reject(IsEvenContext $ctx, string $required): void
    {
    ...
    private function _track(IsEvenContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
