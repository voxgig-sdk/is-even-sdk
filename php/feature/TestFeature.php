...
// IsEven SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IsEvenTestFeature extends IsEvenBaseFeature
{
    ...
    public function init(IsEvenContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IsEvenContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IsEvenContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IsEvenContext $ctx, $op, $args): array
    {
