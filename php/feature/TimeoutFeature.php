...
class IsEvenTimeoutFeature extends IsEvenBaseFeature
{
    ...
    private function _with_timeout(IsEvenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IsEvenContext $_ctx, float $ms): void
    {
        $client = $this->client;
