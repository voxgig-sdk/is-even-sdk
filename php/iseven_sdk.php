...
class IsEvenSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = IsEvenHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = IsEvenHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!IsEvenFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, IsEvenFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return IsEvenUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = IsEvenHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = IsEvenHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = IsEvenHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new IsEvenError($op . "_allow",
                "IsEvenSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = IsEvenHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new IsEvenError("graphql_error",
                "IsEvenSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function NumberParity($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_number_parity === null) {
                $this->_number_parity = new NumberParityEntity($this, null);
            }
            return $this->_number_parity;
        }
        return new NumberParityEntity($this, $data);
    }
