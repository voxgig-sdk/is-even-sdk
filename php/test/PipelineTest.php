...
{
    private static function utility(): IsEvenUtility
    {
        return new IsEvenUtility();
    }
    ...
    private static function ctx(array $over = []): IsEvenContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IsEvenContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IsEvenOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IsEvenError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IsEvenOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IsEvenMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IsEvenOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IsEvenMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IsEvenOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IsEvenMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IsEvenSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IsEvenMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IsEvenResponse([]),
            'result' => new IsEvenResult([]),
        ]);
        [, $err] = IsEvenMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IsEvenSpec(['step' => 's']),
            'response' => new IsEvenResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IsEvenResult([]),
        ]);
        [, $err] = IsEvenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IsEvenSpec(['step' => 's']),
            'response' => new IsEvenResponse(self::resp(200, ['v' => 1])),
            'result' => new IsEvenResult([]),
        ]);
        [, $err] = IsEvenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IsEvenSpec(['step' => 's']),
            'response' => new IsEvenResponse(self::resp(200, ['v' => 2])),
            'result' => new IsEvenResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IsEvenMakeResponse::call($ctx);
    ...
    {
        $preset = new IsEvenResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IsEvenSpec([]),
            'response' => new IsEvenResponse([]),
            'result' => new IsEvenResult([]),
        ...
        [$got, $err] = IsEvenMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IsEvenResult([])]);
        [, $err] = IsEvenMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IsEvenSpec([]), 'result' => null]);
        [, $err] = IsEvenMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IsEvenSpec(['step' => 's']),
            'result' => new IsEvenResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IsEvenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IsEvenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IsEvenSpec(['step' => 's']),
            'result' => new IsEvenResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IsEvenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IsEvenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IsEvenResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IsEvenSpec([]),
            'result' => new IsEvenResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IsEvenMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IsEvenMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IsEvenError('boom', 'boom');
        $utility->fetcher = function (IsEvenContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IsEvenSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IsEvenMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IsEvenContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IsEvenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IsEvenResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IsEvenContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IsEvenSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IsEvenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IsEvenResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IsEvenSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IsEvenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IsEvenMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IsEvenMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IsEvenResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IsEvenDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IsEvenResult(['ok' => false])]);
        $this->expectException(IsEvenError::class);
        IsEvenDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IsEvenResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IsEvenMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IsEvenBaseFeature();
        $b = new IsEvenBaseFeature();
        IsEvenFeatureAdd::call($ctx, $a);
        IsEvenFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IsEvenBaseFeature
    {
        $f = new IsEvenBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IsEvenFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): IsEvenContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new IsEvenSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IsEvenPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IsEvenResponse(['headers' => null]),
            'result' => new IsEvenResult([]),
        ]);
        IsEvenResultHeaders::call($ctx);
