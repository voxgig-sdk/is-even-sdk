...
// IsEven SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IsEvenSDK::test)
...
{
    private const SDK_CLASS = 'IsEvenSDK';
    ...
    private const SDK_BASE = 'iseven_sdk';
