...
class IsEvenTestRunner
{
    ...
    {
        $live = self::getenv('IS_EVEN_TEST_LIVE');
        $override = self::getenv('IS_EVEN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IS_EVEN_TEST_EXPLAIN');
...
class_alias('IsEvenTestRunner', 'Runner');
class_alias('IsEvenHelpers', 'Helpers');
