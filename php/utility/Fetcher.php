...
class IsEvenFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IsEvenSDK/1.0)';
    ...
    public static function call(IsEvenContext $ctx, string $fullurl, array $fetchdef): array
    {
