...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.NumberParity()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/is-even-sdk/releases)) or
