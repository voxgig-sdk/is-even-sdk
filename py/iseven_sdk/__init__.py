...
from iseven_sdk.utility import register

# Load features
from iseven_sdk.feature.base_feature import IsEvenBaseFeature
from iseven_sdk.features import _has_feature, _make_feature
...
class IsEvenSDK:
    ...
    def get_utility(self):
        return IsEvenUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IsEvenSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def NumberParity(self, data=None) -> "NumberParityEntity":
        ...
        from iseven_sdk.entity.number_parity_entity import NumberParityEntity
