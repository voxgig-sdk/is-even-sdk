...
from iseven_sdk.core.helpers import get_ctx_prop, to_map
...
class IsEvenContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, IsEvenResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IsEvenError(code, msg, self)
