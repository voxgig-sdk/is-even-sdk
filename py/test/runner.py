...
class IsEvenTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IsEvenTestRunner.getenv("ISEVEN_TEST_LIVE")
        override = IsEvenTestRunner.getenv("ISEVEN_TEST_OVERRIDE")
        ...
        explain = IsEvenTestRunner.getenv("ISEVEN_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["ISEVEN_TEST_EXPLAIN"] = explain
