...
from iseven_sdk.core.spec import IsEvenSpec
from iseven_sdk.core.result import IsEvenResult
from iseven_sdk.core.response import IsEvenResponse
from iseven_sdk.core.operation import IsEvenOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = IsEvenSDK.test(None, None)
        ...
        class TestInitFeature(IsEvenBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IsEvenBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IsEvenSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IsEvenSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IsEvenSDK.test(None, setup_opts)
