# IsEven SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IsEvenSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IsEvenSDK(...) and IsEvenSDK.test(...) become
#      IsEvenSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "iseven_sdk"
_SDK_CLASS = "IsEvenSDK"
