...
class NumberParityEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IS_EVEN_TEST_NUMBER_PARITY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def number_parity_basic_setup(extra)
  ...
  entid_env_raw = ENV["IS_EVEN_TEST_NUMBER_PARITY_ENTID"]
